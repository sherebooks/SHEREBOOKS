...
@implementation ReaderAppDelegate
{
	...
	ReaderMainViewController *readerController;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	readerController = [[ReaderMainViewController alloc] initWithNibName:nil bundle:nil];
    
	navigationController = [[UINavigationController alloc] initWithRootViewController:readerController];
